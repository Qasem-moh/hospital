...
export const App = () => {
  ...
  //check if Id in local storage
  // const checkID = () => {
  //   let arr = [];
  //   const data = JSON.parse(localStorage.getItem("patinats"));
  //   for (let i = 0; i < data.length; i++) {
  //     arr.push(data[i].ID_Patinat);
  //     console.log("ID", data[i].ID_Patinat);
  //   }
  //   console.log("check", arr);
  //   console.log(arr.includes(id));
  //   if (arr.includes(idN) === true) {
  //     document.getElementById("ID_Patinat").style.border = "1px solid red";
  //     document.getElementById("ErrorID").innerText = "id is not correct";
  //   }
  // };
